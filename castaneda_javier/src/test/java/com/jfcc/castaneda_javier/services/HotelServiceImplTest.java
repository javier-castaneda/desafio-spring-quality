...
import com.jfcc.castaneda_javier.exceptions.hotel.DestinationNotFoundException;
...
class HotelServiceImplTest {
    ...
    @Test
    void getHotels() throws WrongDateFormatException, DestinationNotFoundException, WrongDateIntervalException {
    ...
    private List<HotelDTO> getList(){
        ...
        HotelDTO hotel4 = new HotelDTO("HB-0002","Hotel Bristol 2", "Buenos Aires", "Doble", (long)7200, LocalDate.of(2021,02,12),LocalDate.of(2021,04,17),false);
        ...
        HotelDTO hotel12 = new HotelDTO("BG-0004","Bocagrande", "Cartagena", "Múltiple", (long)9370, LocalDate.of(2021,04,17),LocalDate.of(2021,03,20),false);
